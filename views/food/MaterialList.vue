  ...
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-dropdown v-if="selectedRowKeys.length > 0">
        <a-menu slot="overlay">
          <a-menu-item key="1" v-has="'material:delete'" @click="batchDel"><a-icon type="delete"/>删除</a-menu-item>
    ...
    data () {
      return {
        created() {
          ...
          this.columns = colAuthFilter(this.columns,'material:');
          this.loadData();
          this.initDictConfig();
        },
        items: [],
    ...
    methods: {
      ...
      save(rows){
         ...
         for(var j=0,len=arr.length;j<len;j++){
          ...
          getAction(that.url.compagesUrl, {items:formData}).then((res) => {
              if (res.success) {
