<template>
  <a-card :bordered="false">
    ...
    <accountitem-modal ref="modalForm" @ok="modalFormOk"></accountitem-modal>
  </a-card>
</template>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/accountitem/accountitem/list",
          delete: "/accountitem/accountitem/delete",
          deleteBatch: "/accountitem/accountitem/deleteBatch",
          exportXlsUrl: "/accountitem/accountitem/exportXls",
          importExcelUrl: "accountitem/accountitem/importExcel",
        },
        dictOptions:{},
      }
    },
