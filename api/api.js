...
//用户管理
const addTenant = (params) => postAction("/sys/user/addTenant", params);
const updateTenant = (params) => postAction("/sys/user/updateTenant", params);
const deleteTenant = (params) => postAction("/sys/user/deleteTenant", params);
